...
public class ShoppingServlet extends HttpServlet {
  ...
  public void doPost (HttpServletRequest req, HttpServletResponse res)
    ...
    if (do_this != null) {
      ...
      blist.addElement("The Girl on the Train. Puala Hawkins $23.99");
      blist.addElement("The Nightingale. Kristin Hannah $14.99");
      blist.addElement("Red Queen. Victoria Aveyard $12.99");
      blist.addElement("All the Bright Places. Jennifer Niven $24.99");
